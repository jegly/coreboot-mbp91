...
/*
 * GPIO configuration read from this board running the vendor firmware
 * (Apple EFI 233.0.0.0.0) with `inteltool -g` on 2026-08-28.
 * Raw register dump preserved in the project notes as inteltool-gpio.txt:
 *
 *   use_sel1   = 0xbdebfdff
 *   io_sel1    = 0xaf166eff
 *   lvl1       = 0xdf9a6fb7
